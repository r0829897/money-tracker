...
export default AddButton = ({ onPress, user }) => {
  ...
  const handlePress = () => {
    ...
    axios
      .post(`${URL_SERVER}api/payments/${user._id.toString()}`, {
        title,
        amount,
      })
      .then((res) => {
        ...
        axios
          .post(`${URL_SERVER}api/currentAmount/${user._id.toString()}`, {
            currentAmount: user.currentAmount + Number(amount),
          })
          .then((res) => {
            updatedUser = res.data;
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.buttonsContainer}>
              ...
              <TouchableOpacity
                style={{ ...styles.button, flexBasis: 80 }}
                onPress={() => {
